...
//             Venda venda1 = new Venda("1", Date.valueOf("2021-01-01"), "Pendente", "Venda pendente", 1, 664.58, "ML",produto1);
//             Venda venda2 = new Venda("2", Date.valueOf("2021-02-01"), "Pendente", "Venda pendente", 1, 664.58, "ML",produto2);
//             Venda venda3 = new Venda("3", Date.valueOf("2021-01-02"), "Pendente", "Venda pendente", 1, 1169.23, "ML",produto3);
//             Venda venda4 = new Venda("4", Date.valueOf("2021-02-02"), "Pendente", "Venda pendente", 1, 1169.23, "ML",produto3);
